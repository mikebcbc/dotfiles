...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(launchPrefix .. BROWSER))
...
-- Lid / dock clamshell rules
hl.bind("switch:on:Lid Switch", function()
	sync_laptop_monitor(true)
end, { locked = true })
hl.bind("switch:off:Lid Switch", function()
	sync_laptop_monitor(false)
end, { locked = true })
hl.on("monitor.added", function()
	sync_laptop_monitor()
end)
hl.on("monitor.removed", function(mon)
	sync_laptop_monitor(nil, mon and mon.name)
end)
