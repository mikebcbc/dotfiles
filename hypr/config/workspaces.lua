...
hl.workspace_rule({ workspace = "name:Primary", monitor = MONITOR1, default = true, persistent = true })
hl.workspace_rule({ workspace = "name:Research", monitor = MONITOR1, default = false, persistent = true })
hl.workspace_rule({ workspace = "name:Coding", monitor = MONITOR1, default = false, persistent = true })
